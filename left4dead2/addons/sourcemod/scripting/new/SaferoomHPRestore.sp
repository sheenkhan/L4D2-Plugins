...
public Plugin:myinfo =
{
	...
	author = "ConnerRia, Dragokas, KoMiKoZa",
...
public void OnPluginStart()
{
	...
	hUseCustomValue = CreateConVar("hpr_customvalue", "0", "Set to 1 if you want to input your own saferoom hp value. Uses the z_survivor_respawn_health value otherwise. Disabled by default.", FCVAR_PROTECTED|FCVAR_REPLICATED);
	...
	AutoExecConfig(true, "SaferoomHPRestore");
