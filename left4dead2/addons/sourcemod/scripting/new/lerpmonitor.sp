...
public OnPluginStart() {
	...
	cVarAllowedLerpChanges = CreateConVar("sm_allowed_lerp_changes", "1", "允许中途更改lerp");
	cVarLerpChangeSpec = CreateConVar("sm_lerp_change_spec", "0", "在超过lerp变化计数时移至观众吗？");
	cVarReadyUpLerpChanges = CreateConVar("sm_readyup_lerp_changes", "1", "允许在准备过程中进行lerp变化");
	cVarMinLerp = CreateConVar("sm_min_lerp", "0.000", "最小允许lerp值");
	cVarMaxLerp = CreateConVar("sm_max_lerp", "0.200", "最大允许lerp值");
